...
def check_users():
    ...
    db_users = cursor.fetchall() #The difference between fetchone and fetchall is that the fetch all gives you a list of list i.e [[],[],[]] while fetchone gives you a list of random items
